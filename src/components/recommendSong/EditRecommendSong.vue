<template>
    <div class="edit-recommendSong-container" v-show="show">
    ...
    export default {
      ...
      methods: {
        ...
        confirm(){
          ...
          this.$axios.post("/addRecommendSong", dataList).then( res => {
