<template>
  <div class="edit-listen-listen-type-container" v-show="show">
...
<script>
  export default {
    ...
    methods: {
      ...
      confirm() {
        var type = this.form.id ? "1": "0"; //1：修改 2：新增
        var addParam = {
          type,
        ...
        this.$axios.post("/addListenListenType", dataList).then( res => {
...
<style scoped lang="less">
  .edit-listen-listen-type-container {
    position: fixed;
    top: 0;
    left: 0;
    width: 100%;
